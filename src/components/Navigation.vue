<template>
  <div>
    ...
    <v-app-bar app :color="color" :flat="flat" dark class="px-0 px-md-15 px-xl-15" :class="{ expand: flat }">
      <v-toolbar-title class="d-flex">
        <v-img src="@/assets/img/logo-kibaid.png" max-width="50px" width="100%" height="100%" object-fit="contain" class="my-auto mr-3" />
